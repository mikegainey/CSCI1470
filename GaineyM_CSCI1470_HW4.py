...
#     If the amount tendered is sufficient to cover the cost of the item, compute the change ...
#
...
#
#     Otherwise (if the amount tendered is not sufficient), print an error message
#
...
while another == 'y':
    ...
    else: # the amount tendered was not sufficient to cover the cost of the item
