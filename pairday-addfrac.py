...
print()
print("Let's add two fractions!  Press <Enter> for numerator1 to quit.")
print()

while True:

    n1 = input("Enter numerator1  : ")
    if n1 == '': # end the program when the user presses <Enter> for numerator1 
        break
    else:
        n1 = int(n1)
